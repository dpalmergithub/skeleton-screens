...
<script>
    import LinkedInProfileBlockTemplate from "@/skeletonTemplates/LinkedInProfileBlock"
    ...
    export default {
        ...
        data() {
            return {
                sourceCode: {
                    htmlSourceCode: LinkedInProfileBlockTemplate.htmlSourceCode,
                    cssSourceCode: LinkedInProfileBlockTemplate.cssSourceCode
                }
            }
        }
    }
