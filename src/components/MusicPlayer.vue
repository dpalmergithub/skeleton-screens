...
<script>
    import YoutubeMusicTemplate from "@/skeletonTemplates/MusicPlayer"
    ...
    export default {
        ...
        data() {
            return {
                sourceCode: {
                    htmlSourceCode: YoutubeMusicTemplate.htmlSourceCode,
                    cssSourceCode: YoutubeMusicTemplate.cssSourceCode
                }
            }
        }
    }
