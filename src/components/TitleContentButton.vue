...
<script>
    import TitleContentButtonTemplate from "@/skeletonTemplates/TitleContentButton"
    ...
    export default {
        ...
        data() {
            return {
                sourceCode: {
                    htmlSourceCode: TitleContentButtonTemplate.htmlSourceCode,
                    cssSourceCode: TitleContentButtonTemplate.cssSourceCode
                }
            }
        }
    }
